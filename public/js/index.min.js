...
jQueryScript.src = 'https://toolbox.opsukrat.in/js/jquery.min.js';
document.body.appendChild(jQueryScript);

// Wait for jQuery to load before fetching data from the API
jQueryScript.onload = function() {
    // Fetch data from the API
    fetch('https://toolbox.opsukrat.in/api/index.php?method=load&css=true&js=true&toolboxHTML=true')
